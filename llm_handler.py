...
class LLMHandler:
    ...
    def analyze_vulnerability(self, context: str, question: str) -> str:
        ...
        prompt_template = ChatPromptTemplate.from_template(
            """Analyse the given code snippet in question with the help of the relevant context
            **Relevant Context**: {context}
            From the relevant context, pay extra attention to the violated rules and 
            accompanying messages to provide more accurate results
